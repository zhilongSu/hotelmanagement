...
/**
 * Servlet implementation class RegisterRoomServlet1
 */
@WebServlet("/RegisterRoomServlet1")
public class RegisterRoomServlet1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegisterRoomServlet1() {
        super();
